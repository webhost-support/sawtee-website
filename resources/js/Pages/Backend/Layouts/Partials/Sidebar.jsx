import { Box, Flex, Text, useColorModeValue, Icon, Show, Image } from '@chakra-ui/react';
...
export default function Sidebar({ menu, isOpen, props }) {
	return (
		<Box
			...
			{...props}
		>
			<Flex flexDir={'column'} gap="2" px="4" py="5" justify="center" align="center">
					...
					menu.map(item => {
						return (
							<Box key={item.name} role="group">
								<Link href={route(item.route)} preserveState={true} preserveScroll={true}>
