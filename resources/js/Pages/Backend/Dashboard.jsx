			...
			<Box maxW="7xl" mx={'auto'} px={{ base: 2, sm: 12, md: 17 }}>
				{auth.user.email_verified_at == null && (
					<Alert status="warning" variant="left-accent" fontSize={'sm'} mb={3}>
						<AlertIcon />
						<Text fontWeight={'bold'}>Seems like you have not verified your email address,&nbsp;</Text>
						<Text>
							please verify your email by clicking the verification link sent to your email(
							{auth.user.email}).
						</Text>
					</Alert>
				)}
	...
	return (
		...
		>
			<Flex justifyContent={'space-between'}>
				<Box pl={{ base: 2, md: 4 }}>
					<StatLabel fontWeight="medium" fontSize="xl" textTransform={'uppercase'} isTruncated>
						{title}
					</StatLabel>
