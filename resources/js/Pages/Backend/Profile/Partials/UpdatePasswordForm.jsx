...
export default function UpdatePasswordForm({ className = '' }) {
	...
	return (
		<Box as="section" className={className}>
			...
			<VStack as="form" gap={4} onSubmit={updatePassword} mt={6} py={6} alignItems={'start'}>
				<FormControl isRequired>
					...
					<FormErrorMessage className="mt-2">{errors.current_password}</FormErrorMessage>
				</FormControl>
				...
				<FormControl isRequired>
					...
					<FormErrorMessage className="mt-2">{errors.password}</FormErrorMessage>
				</FormControl>
				...
				<FormControl isRequired>
					...
					<FormErrorMessage className="mt-2">{errors.password_confirmation}</FormErrorMessage>
				</FormControl>
