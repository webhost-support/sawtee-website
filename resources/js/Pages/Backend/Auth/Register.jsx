						...
						>
							<VStack spacing={4} w="100%">
								...
								<FormControl id="password" isInvalid={errors.password}>
									...
									{errors.password && <FormErrorMessage mt={2}>{errors.password}</FormErrorMessage>}
								</FormControl>
								<FormControl id="password_confirmation" isInvalid={errors.password_confirmation}>
									...
									{errors.password_confirmation && (
										<FormErrorMessage mt={2}>{errors.password_confirmation}</FormErrorMessage>
									)}
								</FormControl>
							</VStack>
							<Stack direction="row" justify="space-between" alignItems={'center'} w="100%">
								...
								<PrimaryButton type="submit" rounded="md" isLoading={processing} minW={'64'}>
									Register
								</PrimaryButton>
							</Stack>
						</VStack>
