...
export default function EditTeamForm({ team }) {
	...
	const [image, setImage] = React.useState(team.media[0] ? team.media[0].original_url : null);
		...
		<VStack as="form" onSubmit={submit} gap="10" alignItems={'start'}>
			<HStack w="full" gap={8} justifyContent="space-evenly" alignItems="center">
				...
				<FormControl isRequired>
					...
					<NumberInput id="order" name="order" value={data.order} onChange={e => setData('order', Number(e))}>
						<NumberInputField />
						<NumberInputStepper>
							<NumberIncrementStepper />
							<NumberDecrementStepper />
