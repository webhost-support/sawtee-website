...
const NewsletterPost = ({ post }) => {
	...
	useEffect(() => {
		document.addEventListener('adobe_dc_view_sdk.ready', function () {
			...
			const adobeDCView = new AdobeDC.View({
				clientId: 'a216d6a763e14deda203664862f3dead' || 'a0b938dc0dda4ceba3ce648ec3caeb6a',
				divId: 'adobe-dc-view',
			});
	...
	return (
		<Box pt="40px">
			<Head>
				<script src="https://acrobatservices.adobe.com/view-sdk/viewer.js" defer />
			</Head>

			{post.content ? (
				<Container centerContent maxW="7xl">
					<Box className="newsletter-html" dangerouslySetInnerHTML={{ __html: post.content }} />
					<InertiaChakraLink href={pdf.original_url}>
						<Button colorScheme="primary">View PDF</Button>
					</InertiaChakraLink>
				</Container>
			) : (
				<Box id="adobe-dc-view" className="full-window-div" style={{ width: '100%', margin: '0 auto' }}></Box>
			)}
		</Box>
	);
};
