...
import { Box, Text, Heading, Container, SimpleGrid, Image, LinkBox, useColorModeValue } from '@chakra-ui/react';
...
export default function OurWork({ themes, sections }) {
	...
	return (
		<Container className="intro" pos="relative" py="80px" maxW="5xl" px={{ base: 5, md: 10 }} centerContent>
			<Heading as={'h2'} fontSize={{ base: 'xl', md: '2xl' }} mb={6} textAlign="center">
				Thematic Areas
			</Heading>
			...
			<SimpleGrid columns={{ base: 1, lg: 2 }} placeItems="center" spacing={10} mb={4}>
						...
						return (
							...
							>
								<Image
									...
									aspectRatio={'3/4'}
									w={['xs', 'sm']}
									src={media[0] ? media[0].original_url : '/assets/SM-placeholder-300x150.png'}
								/>
								<Box
