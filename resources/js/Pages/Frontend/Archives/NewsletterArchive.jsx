...
import { Text, HStack, Box, Heading, chakra, Container, VStack, Flex, Icon, useColorModeValue } from '@chakra-ui/react';
...
const Card = ({ title, category, excerpt, published_at, media }) => {
	...
	return (
		...
		>
			<Icon as={FaRegNewspaper} w={10} h={10} color={useColorModeValue('primary.500', 'primary.200')} />
			<Box flex={1}>
				{category && (
