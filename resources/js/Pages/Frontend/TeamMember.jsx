import { Box, Text, Stack, Avatar, useColorModeValue, Icon, Image, Show } from '@chakra-ui/react';
...
const TeamMember = ({ member, ...rest }) => {
	...
	return (
		...
		>
			...
			<Stack direction="column" spacing={4} textAlign="left" maxW="2xl" color={useColorModeValue('#000', 'gray.200')}>
