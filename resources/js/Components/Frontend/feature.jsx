		...
		<Stack align={'center'} spacing={{ base: 8, md: 10 }} direction={{ base: 'column', lg: 'row' }} {...rest}>
			<Stack flex={1} spacing={{ base: 5, md: 10 }}>
				...
				<Text color={useColorModeValue('gray.600', 'gray.300')} fontSize={{ base: 'xs', md: 'sm', lg: 'md' }}>
					Some text about reform monitoring platform. Snippy is a rich coding snippets app that lets you create your own
					code snippets, categorize them, and even sync them in the cloud so you can use them anywhere. All that is
					free!
				</Text>
			</Stack>
