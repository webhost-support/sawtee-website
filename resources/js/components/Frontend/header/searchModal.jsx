...
export default function SearchModal() {
  ...
  function handleSubmit(e) {
    ...
    xhr.send();
    !recentQueries.includes(searchQuery) &&
      setRecentQueries([...recentQueries, searchQuery]);
  }
    ...
    >
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            {searchQuery && posts
              ? `Found ${posts.length} result for "${searchQuery}"`
                ...
                <ul>
                  {recentQueries.map((query, index) => (
                    <li
                      ...
                      onKeyUp={e => e.key === 'Enter' && setSearchQuery(query)}
                    >
                      <svg
